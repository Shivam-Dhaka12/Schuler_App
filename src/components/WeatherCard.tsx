      ...
      <div className="grid grid-cols-10  flex-col items-stretch">
        <div className="col-span-7 px-2">
          ...
          <div className="grid grid-cols-2 px-2 py-4 text-center md:px-6">
            <div className="py-2">
              <img src="./wind.png" className="mx-2 inline" width={20} />
              <span className="text-sm">{city.wind} m/s</span>
            </div>
            <div className="py-2">
              <img src="./thermometer.png" className="mx-2 inline" width={20} />
              <span className="text-sm">{city.temperature}&#176;C</span>
            </div>{" "}
            <div className="py-2">
              <img src="./humidity.png" className="mx-2 inline" width={20} />
              <span className="text-sm">{city.humidity} %</span>
            </div>{" "}
            <div className="py-2">
              <img src="./sunny.png" className="mx-2 inline" width={20} />
